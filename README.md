...
OpenMusic API adalah sebuah layanan RESTful API untuk pengelolaan lagu dan album musik. Proyek ini dibangun menggunakan Node.js, Express, dan database PostgreSQL.
